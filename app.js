...
const SOURCES = [['Income', ''], ['Free Now', 'FN'], ['Uber', 'U'],
                 ['TapTaxi', 'TT'], ['Cabbi', 'CB'], ['Lynk', 'LK'], ['Others', '⋯']];
const CATS = {
  income: SOURCES,
...
const CHIP = {
  ...
  'TapTaxi':  '<span class="chip c-taptaxi">' + TAXI_SVG + '</span>',
  'Cabbi':    '<span class="chip c-cabbi">' + TAXI_SVG + '</span>',
  'Lynk':     '<span class="chip c-lynk">' + TAXI_SVG + '</span>',
